...
<!-- Romance Section -->
<div class="container mt-4">
    <h1>Sci-Fi Section</h1>
    <h4>All science was fiction once!</h4>
    <br>
...
<div class="container mt-4">
    <h1>All <b>LibraNova</b> Science Collection</h1>
    <h4>Fiction is Just Undiscovered Science!</h4>
    <!-- Grid view of book sections -->
    <?php
    GenreAllBooks("Sci-Fi");
    ?>
