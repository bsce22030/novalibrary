...
$sql = "SELECT * FROM books WHERE Genre = 'Drama'";
...
<div class="container mt-4">
        <h1>All <b>LibraNova</b> Drama Collection</h1>
        <h4>Captivating Drama Collection from World Renouned Authors</h4>
