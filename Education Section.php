...
<div class="container mt-4">
    ...
    <h4>Seeking Education is the biggest virtue!</h4>
    <br>
...
<div class="container mt-4">
    <h1>All <b>LibraNova</b> Education Collection</h1>
    <h4>Education Collection By Nova Libra!</h4>
    <!-- Grid view of book sections -->
    <?php
    GenreAllBooks("Education");
    ?>
